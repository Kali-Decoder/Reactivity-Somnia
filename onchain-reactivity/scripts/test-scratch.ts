...
const SCRATCH_CARD_ABI = [
  ...
  "event ScratchRequested(address indexed player,uint256 scratchId,uint256 nonce)",
  "event ScratchResolved(address indexed player,uint256 scratchId,uint256 reward,uint256 randomWord)"
];

const VALIDATOR = "0x0000000000000000000000000000000000000100";
...
async function main() {
  const contract =
    ...
    "0x966fcF1D7F7602D4EFE072E221f181906C61a0e3";
